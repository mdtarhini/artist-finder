    ...
    <div className="relative h-full w-full" ref={menuRef}>
      {searchable ? (
        <input
          type="text"
          id={id}
          className={`${buttonClassName} w-full bg-white h-full pl-3 pr-10 py-2 text-left cursor-default focus-inside text-sm placeholder-black`}
        ...
        <button
          id={id}
          className={`${buttonClassName} w-full bg-white h-full pl-3 pr-10 py-2 text-left cursor-default focus-inside sm:text-sm`}
          onClick={toggle}
        >
